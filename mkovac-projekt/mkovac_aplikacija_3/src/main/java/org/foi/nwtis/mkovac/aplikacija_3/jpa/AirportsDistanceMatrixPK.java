package org.foi.nwtis.mkovac.aplikacija_3.jpa;
...
/**
 * The primary key class for the AIRPORTS_DISTANCE_MATRIX database
 * table.
 * 
 */
@Embeddable
public class AirportsDistanceMatrixPK implements Serializable {
  ...
  @Column(name = "ICAO_FROM", insertable = false, updatable = false,
      unique = true, nullable = false, length = 10)
  private String icaoFrom;

  @Column(name = "ICAO_TO", insertable = false, updatable = false,
      unique = true, nullable = false, length = 10)
  ...
  public boolean equals(Object other) {
    ...
    AirportsDistanceMatrixPK castOther =
        (AirportsDistanceMatrixPK) other;
    return this.icaoFrom.equals(castOther.icaoFrom)
        && this.icaoTo.equals(castOther.icaoTo)
