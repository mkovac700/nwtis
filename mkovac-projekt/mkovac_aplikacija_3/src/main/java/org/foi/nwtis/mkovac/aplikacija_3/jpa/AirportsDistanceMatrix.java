...
/**
 * The persistent class for the AIRPORTS_DISTANCE_MATRIX database
 * table.
 * 
 */
@Entity
...
public class AirportsDistanceMatrix implements Serializable {
  ...
  @ManyToOne
  @JoinColumn(name = "ICAO_FROM", nullable = false,
      insertable = false, updatable = true)
  private Airports airport1;

  // bi-directional many-to-one association to Airport
  @ManyToOne
  @JoinColumn(name = "ICAO_TO", nullable = false, insertable = false,
      updatable = true)
