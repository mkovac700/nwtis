<%@page import="org.foi.nwtis.mkovac.zadaca_3.ws.WsAerodromi.endpoint.UdaljenostAerodromKlasa"%>
...
<body>
	...
	<main>
		...
		List<UdaljenostAerodromKlasa> udaljenostAerodromi =
		    (List<UdaljenostAerodromKlasa>) request.getAttribute("udaljenostAerodromi");
		...
		<table border=1>
			...
			<%
			for (UdaljenostAerodromKlasa a : udaljenostAerodromi) {
			%>
			<tr>
				<td><%=a.getIcao()%></td>
				<td><%=a.getKm()%></td>
